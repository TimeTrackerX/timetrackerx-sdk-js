...
import { ApiClass, BaseApiItem } from './ApiClass';
...
describe('RestFulApi', () => {
    ...
    describe('list', () => {
        it('should list items successfully', async () => {
            ...
            const result = await apiClass.list({ jwt });
    ...
    describe('create', () => {
        it('should create items successfully', async () => {
            ...
            const result = await apiClass.create({ payload, jwt });
    ...
    describe('update', () => {
        it('should update items successfully', async () => {
            ...
            const result = await apiClass.update({ id: 4, payload, jwt });
    ...
    describe('delete', () => {
        it('should delete items successfully', async () => {
            ...
            const result = await apiClass.delete({ id: 4, jwt });
